...
db.games.insertMany([
  ...
  },
  {
    ...
    summary: 'Pequeno resumo sobre o jogo',
    description:
      'Se eu tivesse que escolher entre minha esposa e o General Galba, é claro que eu ia escolher nosso General! Ele me ama muito mais que aquela velhaca!',
    genre: [],
    status: 'demo',
    images: [
      {
  ...
  },
  {
    title: 'Vizinha Viral',
    summary:
      'Em meio a um surto de um vírus novo, você está preso em casa com uma vizinha inconvieniente e aparentemente infectada!',
    description:
      'Em meio a um surto de um vírus novo, você está preso em casa com uma vizinha inconvieniente e aparentemente infectada! Evite ser infectado até o resgate chegar, mas mantenha a conversa, pois ela pode sair se ficar chateada!',
    genre: [],
    status: 'released',
    images: [
      {
  ...
  },
  {
    ...
    summary:
      'Nada melhor para estreitar laços entre pais e filhos do que construir uma casa na árvore! Infelizmente, seu pai é muito metódico... Melhor segui-lo passo a passo para evitar que fique bravo!',
    genre: [],
    status: 'released',
    images: [
      {
