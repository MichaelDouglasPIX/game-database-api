...
class GamingPlatformsController {
    static async listGamingPlatforms (req, res) {
        try {
            ...
            res.status(500).json({ message: `${erro.message} - failure to obtain gaming platforms`});
        }
    };
    ...
    static async registerGamingPlatform (req, res) {
        try {
            ...
            res.status(500).json({ message: `${erro.message} - failed to register gaming platform`});
        }
    };
    ...
    static async listGamingPlatformById (req, res) {
        try {
            ...
            res.status(500).json({ message: `${erro.message} - failure to obtain gaming platform`});
        }
    };
    ...
    static async updateGamingPlatformById (req, res) {
        try {
            ...
            res.status(500).json({ message: `${erro.message} - failed to update gaming platform`});
        }
    };
    ...
    static async deleteGamingPlatformById (req, res) {
        try {
            ...
            res.status(500).json({ message: `${erro.message} - failed to delete gaming platform`});
        }
    };
}
