...
class GenreController {
    static async listGenres(req, res) {
        try {
            ...
            res.status(500).json({ message: `${error.message} - failure to obtain genres` });
        }
    };
    ...
    static async registerGenre(req, res) {
        try {
            ...
            res.status(500).json({ message: `${error.message} - failed to register genrer` });
        }
    };
    ...
    static async listGenreById(req, res) {
        try {
            ...
            res.status(500).json({ message: `${error.message} - failure to obtain genre` });
        }
    };
    ...
    static async updateGenreById(req, res) {
        try {
            ...
            res.status(500).json({ message: `${error.message} - failed to update genre` });
        }
    };
    ...
    static async deleteGenreById(req, res) {
        try {
            ...
            res.status(500).json({ message: `${error.message} - failed to delete genre` });
        }
    };
};
